...
import { Search, MoreHorizontal, FileText, Loader2, Calendar, HardDrive, SlidersHorizontal, X, Tag, Filter } from 'lucide-react';
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto h-full flex flex-col">
      ...
      <div className="bg-white rounded-xl border border-border shadow-sm overflow-hidden flex-1 flex flex-col">
        <div className="grid grid-cols-12 gap-4 p-4 border-b border-border bg-gray-50 text-xs font-semibold text-gray-500 uppercase tracking-wider shrink-0">
              ...
              {filteredDocuments.map((doc) => (
                ...
                >
                  <div className="col-span-6 flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-medium text-gray-900 group-hover:text-brand-700">{doc.name}</h3>
